		...
		<div class="row">
			...
			<aside class="col-md-4 sidebar sidebar-left">
				...
				<div class="row widget">
					<div class="col-xs-12">
						<h4>Les Best Sellers</h4>
						<p>Dans cette section retrouvez les produits les plus vendus!</p>
					</div>
				</div>
				<div class="row widget">
					<div class="col-xs-12">
						<h4>Nom du produit</h4>
						<p><img src="../../resources/img/1.jpg" alt=""></p>
						<p class="card-text">Description technique</p>
						<p class="card-text">Prix du produit</p>
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="simplenav">
								...
								<b><a href="connexion">Se connecter</a></b>
							</p>
						</div>
					</div>
