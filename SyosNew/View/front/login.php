				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Se connecter</h3>
							<p class="text-center text-muted">Si vous n'avez pas encore de compte SYOS, rendez-vous sur la page d' <a href="register">Inscritpion</a> </p>
							<hr>
							...
							<form method="post">
								...
								<div class="row">
									<div class="col-lg-12 text-center">
										<button class="btn btn-action" name="envoyer" type="submit">Connexion</button>
									</div>
								</div>
							</form>
						</div>
